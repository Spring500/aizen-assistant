...
export function createAssistantMarkdownStyles(): AssistantMarkdownStyles {
  ...
  return {
    markdown: SyntaxStyle.fromStyles({
      ...
      "markup.heading": { fg: systemColors.accent, bg: markdownBackground, bold: true },
      "markup.heading.1": { fg: systemColors.accent, bg: markdownBackground, bold: true },
      "markup.heading.2": { fg: systemColors.accent, bg: markdownBackground, bold: true },
      "markup.heading.3": { fg: systemColors.accent, bg: markdownBackground, bold: true },
      "markup.heading.4": { fg: systemColors.accent, bg: markdownBackground, bold: true },
      "markup.heading.5": { fg: systemColors.accent, bg: markdownBackground, bold: true },
      "markup.heading.6": { fg: systemColors.accent, bg: markdownBackground, bold: true, dim: true },
      ...
      "markup.raw": { fg: systemColors.accent, bg: markdownBackground },
      "markup.link": { fg: systemColors.accent, bg: markdownBackground, underline: true },
      "markup.link.label": { fg: systemColors.accent, bg: markdownBackground, underline: true },
      "markup.link.url": { fg: systemColors.dim, bg: markdownBackground, underline: true },
      "markup.quote": { fg: systemColors.dim, bg: markdownBackground, italic: true },
      "markup.list": { fg: systemColors.accent, bg: markdownBackground, bold: true },
      "punctuation.special": { fg: systemColors.dim, bg: markdownBackground },
    }),
    code: SyntaxStyle.fromStyles({
      default: { fg: systemColors.text, bg: codeBackground },
